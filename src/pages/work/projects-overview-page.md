...
projects:
  ...
  - projectTitle: Design System Documentation
    description: Writing documentation for a brand new design system is really important, and I was able to help write it.
    pageLink: documentation.html
    ariaLabel: Learn more about design system documentation for Crown Equipment.
    buttonText: Visit Crown.com
    buttonLink: https://www.crown.com/en-us/
    hpImage: crown-screenshot-hp.png
    screenshotAltText: Crown Equipment homepage, with a forklift employee standing in front of a Crown work truck, and a carousel of Crown products for users to browse.
  - projectTitle: Design System Builder
    description: I partnered with a colleague to create a proof-of-concept for a design system builder.
    pageLink: ds-builder.html
    ariaLabel: Learn more about the design system builder on GitHub.
    buttonText: Visit Propulsion on GitHub
    buttonLink: https://github.com/sparkbox/propulsion-docs
    hpImage: propulsion-screenshot-hp.png
    screenshotAltText: GitHub page of the publicly available Propulsion docs.
