...
overview: |
  The Adobe Spectrum organization recently embarked in updating their design system from Spectrum 1 to Spectrum 2. I was part of the contracting team assisting the Spectrum CSS engineering team. We introduced major changes by deprecating an older, static documentation site in favor of moving our documentation into the CSS team's Storybook instance, as well as began work on migrating CSS components from the S1 design language to the new S2 language.
